...
// Enable validation layer if being Debug build
...
// Get vkCreateDebugUtilsMessengerEXT by ourselves using vkGetInstanceProcAddr
VkResult CreateDebugYtilsMessengerEXT(VkInstance instance,
...
// Get vkDestroyDebugUtilsMessengerEXT by ourselves using vkGetInstanceProcAddr
...
{
    {{-0.5, -0.5f}, {0.4f, 0.5f, 0.6f}, {1.0f, 0.0f}},
    {{0.5f, -0.5f}, {0.3f, 0.5f, 1.0f}, {0.0f, 0.0f}},
    {{0.5f, 0.5f}, {0.8f, 1.0f, 0.4f}, {0.0f, 1.0f}},
    {{-0.5f, 0.5f}, {1.0f, 0.7f, 0.9f}, {1.0f, 1.0f}}
...
private:
    ...
    void initWindow()
    {
        ...
        // Tell glfw we dont create opengl window, and prevent it from resizing its window size
    ...
    void mainLoop() 
    {
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            // Check events like pressing button
            glfwPollEvents();
...
private:
    ...
    void createInstance()
    {
        ...
        // Check validation layers if it is enabled
    ...
    void setupDebugMessenger()
    {
        ...
        if (CreateDebugYtilsMessengerEXT(instance, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS)
...
private:
    ...
    // Suitable means support graphics queue
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        ubo.model = glm::rotate(glm::mat4(1.0f), time * glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0f));
...
private:
    ...
    bool checkDeviceExtensionSupport(VkPhysicalDevice device)
    {
        ...
        for (const auto& extension : availableExtension) requiredExtensions.erase(extension.extensionName);
